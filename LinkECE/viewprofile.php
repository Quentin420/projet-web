<?php
    ...
    if(isset($_GET['id_user']))
    {
        ...
        $user = mysqli_query($con, "SELECT nom, prenom, avatar FROM `users` WHERE id_user='$idviewed'");
                ...
                $user_viewed_img = $user_viewed['avatar'];
...
<html>
    ...
    <head>
        <title>Bienvenue sur le profil de <?php echo $user_viewed_nom; ?></title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container text-center">  
                ...
                <h2 class="profil"><?= $user_viewed_prenom.' '.$user_viewed_nom?></h2>  
