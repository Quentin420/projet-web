  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-user"></span> <?= $prenom.' '.$nom ?> </a></li>
        <li><a href="login-system/logout.php"><span class="glyphicon glyphicon-log-out"></span> Connexion</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container text-center">    
  <div class="row">
    ...
    <div class="col-sm-3">
        ...
        <div class="well">
            <button type="button" class="btn btn-success"><span class="glyphicon glyphicon-briefcase"></span> Élargir son réseau</button>
        </div>
